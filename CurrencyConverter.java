	...
	public CurrencyConverter()
	 {
		...
		setBounds(100, 100, 950, 604);
		contentPane = new JPanel();
		contentPane.setBackground(new Color(200, 50, 200));
		...
		amounttext.setFont(new Font("Serif", Font.PLAIN, 36));
		amounttext.setBounds(470, 120, 425, 77); 
		contentPane.add(amounttext);
		amounttext.setColumns(10);

		JLabel lblNewLabel = new JLabel("From:");
		lblNewLabel.setForeground(new Color(200, 255, 100));
		...
		lblNewLabel_2.setForeground(new Color(200, 255, 100));
		lblNewLabel_2.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_2.setFont(new Font("Serif", Font.PLAIN, 32));
		...
		lblNewLabel_1.setForeground(new Color(200, 255, 100));
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setFont(new Font("Serif", Font.PLAIN, 32));
		lblNewLabel_1.setBounds(80, 125, 366, 69);
		contentPane.add(lblNewLabel_1);
		JLabel lblNewLabel_3 = new JLabel("CURRENCY CONVERTER");
		lblNewLabel_3.setForeground(new Color(200, 255, 100));
		lblNewLabel_3.setFont(new Font("Serif", Font.PLAIN, 36));
